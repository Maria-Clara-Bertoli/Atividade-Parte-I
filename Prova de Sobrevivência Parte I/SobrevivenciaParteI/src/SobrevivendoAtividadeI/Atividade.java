...
public class Atividade {
	...
	public void PesoPeixe(double peso) {
		...
		System.out.println("O excesso de peso é " + excesso + " quilos" + " e a multa é " + multa +" reais.");
	}
	...
	public void Pintura(double area) {
		...
		preco = latas * 80;
		System.out.println("A quantidade de latas que devem ser compradas são " + latas + " e o valor total é " + preco + " reais");
	}
	...
	public void Pintura2(double area) {
		...
		preco2 = galoes * 25;
		System.out.println("Para litros: A quantidade de latas que devem ser compradas são " + latas + " e o valor total é " + preco + " reais");
		System.out.println("Para galões: A quantidade de galões que devem ser comprados são " + galoes + " e o valor total é " + preco2 + " reais");
	}
